      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-container">
            <h2>Welcome to Datahub<br></h2>
            <h1>Act fast on the special deal before it's gone! <br>
            Buy affordable internet packages.</h1>
            <a href="index.php" class="btn-get-started">Get Started</a>
          </div>
    ...
    <section id="clients" class="clients section light-background">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4" style= "justify-content: center";>
          ...
          <div class="col-xl-3 col-md-2 col-3 client-logo">
            <h1 style="color: blue;">MTN</h1>
          </div><!-- End Client Item -->

          <div class="col-xl-3 col-md-2 col-3 client-logo">
            <h1 style="color: red;">telecel</h1>
          </div><!-- End Client Item -->

          <div class="col-xl-3 col-md-2 col-3 client-logo">
            <h1 style="color: red;">at</h1>
          </div><!-- End Client Item -->
